...
node {
    ...
    // Disable tests for now, most of it is not about the API
    // stage('Test') {
    //     tryStep "test", {
...
if (BRANCH == "master") {
    ...
    stage('Waiting for approval') {
        slackSend channel: '#ci-channel', color: 'warning', message: 'Panorama API is waiting for Production Release - please confirm'
