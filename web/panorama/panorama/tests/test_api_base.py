...
class PanoramaApiTest(APITestCase):
    ...
    def setUpClass(cls):
        ...
        factories.PanoramaFactory.create(
            ...
            status=Panorama.STATUS.done,
            timestamp=factory.fuzzy.FuzzyDateTime(
                datetime.datetime(2015, 1, 1, tzinfo=datetime.timezone.utc), force_year=2015
            ),
            filename=factory.fuzzy.FuzzyText(length=30),
            path=factory.fuzzy.FuzzyText(length=30),
        ...
        factories.PanoramaFactory.create(
            ...
            status=Panorama.STATUS.done,
            timestamp=datetime.datetime(2016, 5, 5, tzinfo=datetime.timezone.utc),
            filename=factory.fuzzy.FuzzyText(length=30),
            path=factory.fuzzy.FuzzyText(length=30),
        ...
        factories.PanoramaFactory.create(
            ...
            status=Panorama.STATUS.done,
            timestamp=datetime.datetime(2017, 5, 5, tzinfo=datetime.timezone.utc),
            filename=factory.fuzzy.FuzzyText(length=30),
            path=factory.fuzzy.FuzzyText(length=30),
        ...
        factories.PanoramaFactory.create(
            ...
            status=Panorama.STATUS.done,
            timestamp=datetime.datetime(2018, 5, 5, tzinfo=datetime.timezone.utc),
            filename=factory.fuzzy.FuzzyText(length=30),
            path=factory.fuzzy.FuzzyText(length=30),
