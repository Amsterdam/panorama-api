...
class TestRender(TestCase):
    ...
    def setUpClass(cls):
        ...
        try:
            ...
            factories.PanoramaFactory.create(
                ...
                geolocation=Point(4.89593266865189, 52.3717022854865, 47.3290048856288),
    ...
    @mock.patch(
        "panorama.transform.utils_img_file.object_store.put_into_panorama_store"
    )
    @mock.patch(
        "panorama.transform.utils_img_file.get_raw_panorama_as_rgb_array",
    ...
    def test_create_and_render_batch(self, mock_read_raw, mock_write_transformed):
        ...
        self.assertTrue(
            mock_write_transformed.called, msg="Write transformed was not called"
        )
